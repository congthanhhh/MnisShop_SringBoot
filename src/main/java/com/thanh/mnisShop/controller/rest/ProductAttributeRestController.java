...
public class ProductAttributeRestController {
    ...
    public List<ProductAttribute> findByProductAndSizeId(@PathVariable Long productId, @PathVariable Long sizeId) {
        return productAttributeRepository.findProductAttributeByProductId(productId,sizeId);
    }
